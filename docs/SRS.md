...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.4. [Требования к безопасности](#P3.2.1.4)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.5. [Требования к производительности](#P3.2.1.5)  
...
##### <a name="P3.2.1.4">3.2.1.4. Требования к безопасности</a>
- Пользователи должны быть авторизованными для просмотра рекордов.
##### <a name="P3.2.1.5">3.2.1.5. Требования к производительности</a>
