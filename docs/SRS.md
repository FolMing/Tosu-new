...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.1. [Требования к эффективности используемых ресурсов](#P3.2.1.1)  
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;3.2.1.2. [Требования к производительности](#P3.2.1.2)  
...
- Опции </br>
Изменение громкости, отключение/включение видеороликов, кнопка "Назад".
...
| Функция | Требование |
| :-------: | :-------: |
| Выбор внутриигрового имени | Приложение должно предоставлять пользователю возможность изменить внутриигровое имя |
...
##### <a name="P3.2.1.1">3.2.1.1. Требования к эффективности используемых ресурсов</a>
- Приложение не должно использовать более 500 мегабайт оперативной памяти при использовании роликов с YouTube 360p качества длительностью 30 секунд.
##### <a name="P3.2.1.2">3.2.1.2. Требования к производительности</a>
...
- Функциональные элементы контрастны фону окна, за исключением игрового экрана в связи с использованием видеороликов.
