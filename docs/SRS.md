...
- Пользователь должен иметь возможность играть вне зависимости от подключения к интернету.
- Пользователь имеет право сохранить свой рекорд на сервере под его именем.
- Пользователь имеет право изменить графический интерфейс используя скины.
#### <a name="P3.1.2">3.1.2. Ограничения и исключения</a>
На операционной системе пользователя должен быть установлен Java Runtime Environment.
...
1. Все элементы должны иметь хорошую контрастность и быть легкоразличимыми;
